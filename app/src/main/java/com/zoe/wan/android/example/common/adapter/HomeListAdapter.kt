...
class HomeListAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    companion object {
        //静态常量
        //banner类型
        private val BannerItemType: Int = 0
        //列表类型
        private val NormalItemType: Int = 1
    }
    ...
    * */
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == BannerItemType)
            return HomeBannerViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.context),
    ...
    class HomeBannerAdapter(bannerData: HomeBannerData?): BannerImageAdapter<HomeBannerDataItem>(bannerData) {
